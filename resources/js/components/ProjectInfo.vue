    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    <span class="pl-3">- import csv file to database. In Tasks module rows will be displayed order by desc;</span>
                </div>
                <div class="row">
                    <span class="pl-3">- RESTful API on Tasks module, use Eloquent Relationships for queries;</span>
                </div>
                <div class="row">
        ...
        <div class="row">
            <div class="col-2 text-right">
                <span><b>Code Source</b></span>
            </div>
            <div class="col-6">
                <div class="row">
                    <span class="pl-3">Click <b><a style="color:red;" href="https://github.com/alexandru1985/task_manager">here</a></b> to see project on GitHub.</span>
                </div>
                <div class="row">
                    <span class="pl-3"> Main file paths:</span>
                </div>
                <div class="row pl-3">
                    <span>- app/Http/Controllers/API;</span>
                </div>
                <div class="row pl-3">
