...
class TasksController extends Controller
{
    ...
    public function index($all = null)
    {
        ...
        if(isset($all)){
                ...
                return Tasks::with('users', 'project', 'client')->latest()->paginate(8);
    ...
    public function store(Request $request)  {
        ...
        if ($validator->fails()) {
            ...
            //collect all the ids 
            $pivot[$user['id']] = ['user_id' => $user['id'], 'task_id' => $tasks->id, 'user_role' => Tasks::getUserRole($user['id'])]; 
            }
    ...
    public function update($id, Request $request)
    {
        ...
        if(isset($request->users)) {
            ...
            foreach ($request->users as $user) {
            //collect all the ids 
            $pivot[$user['id']] = ['user_id' => $user['id'], 'task_id' => $id, 'user_role' => Tasks::getUserRole($user['id'])]; 
            }
    ...
    public function getUsers() {
        return $users = Users::where('role_id', '!=', null)->get();
    }
}
